...
download_ebi <- function(data = "phenotype", 
  ...
  if (reformat) {
    ...
    } else {cat("...Warning: reformat=TRUE but this is only implemented for phenotype data, not genotype data")}
  }
