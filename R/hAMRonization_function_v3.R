...
conda_install(envname="amrgen-reticulate", 
...
#' 
#' @examples harmonize_data(user_software_name = "amrfinderplus", user_software_version = "3.12.8", user_input_filename="ATB_Achromobacter_AFP.tsv", user_database_version = "2024-01-31.1")
#' 
